...
function _topNav() {
    ...
    jQuery("li.search i.fa").click(function () {
        if (jQuery("#header .search-box").is(":visible")) {
            ...
            if (
                jQuery("#header li.quick-cart div.quick-cart-box").is(
                    ":visible"
                )
            ) {
    ...
    jQuery("button.btn-mobile").bind("click", function (e) {
        ...
        if (jQuery(this).hasClass("btn-mobile-active")) {
            ...
            if (
                !jQuery("#topMain").hasClass("nav-onepage") ||
                window.width > 960
            ) {
                /* onepage fix */
    ...
    if (jQuery("#wrapper nav.main-nav").length > 0) {
        ...
        jQuery("#wrapper nav.main-nav>div>ul>li").bind("click", function (e) {
            ...
            if (!jQuery("div", _this).hasClass("main-nav-open")) {
                jQuery(
                    "#wrapper nav.main-nav>div>ul>li>.main-nav-submenu"
...
function _owl_carousel() {
    ...
    if (_container.length > 0) {
        loadScript(
            plugin_path + "owl-carousel/owl.carousel.min.js",
            function () {
    ...
    if (_container2.length > 0) {
        loadScript(
            plugin_path + "owl-carousel-2/owl.carousel.min.js",
            function () {
            ...
            function () {
                if (jQuery().flexslider) {
                    var _controlNav = _container.attr("data-controlNav"),
                        _slideshowSpeed =
                            _container.attr("data-slideshowSpeed") || 7000,
                        _pauseOnHover =
                            _container.attr("data-pauseOnHover") || false;
                    ...
                    var _t = jQuery(this),
                        ...
                        defaults = {
                            ...
                            gallery: {
                                ...
                                tNext: "Next",
                                tCounter:
                                    '<span class="mfp-counter">%curr% / %total%</span>',
                            },
                        };
        ...
        jQuery("a.scrollTo").bind("click", function (e) {
            ...
            if (href != "#" && href != "#top") {
                jQuery("html,body").animate(
                    {
                        scrollTop:
                            jQuery(href).offset().top - parseInt(_offset),
                    },
                    800,
                    "easeInOutExpo"
                );
            ...
            jQuery(window).scroll(function () {
                ...
                if (_currentTop < 768) {
                    ...
                    jQuery("#slider>div").css(
                        "top",
                        _currentTop * 0.5 - Number(_offset)
                    );
...
function _lazyload() {
    ...
    if (_container.length > 0) {
        loadScript(
            plugin_path + "lazyload/jquery.lazyload.min.js",
            function () {
                if (jQuery().lazyload) {
                    _container.each(function () {
                        var _t = jQuery(this),
            ...
            if (jQuery().isotope) {
                ...
                jQuery(window).on("load", function () {
                    var _t = setTimeout(function () {
                        ...
                        jQuery("#portfolio_filter>li>a").bind(
                            "click",
                            function (e) {
                                e.preventDefault();
            ...
            if (jQuery().isotope) {
                ...
                function _recalcW() {
                    ...
                    if (_container.hasClass("fullwidth")) {
                        ...
                        _mR = parseInt(
                            jQuery("#blog>.blog-post-item").css("margin-right")
                        );
                ...
                jQuery(window).on("load", function () {
                    var _t = setTimeout(function () {
                        ...
                        jQuery("#blog_filter>li>a").bind("click", function (e) {
                            ...
                            jQuery("#blog_filter>li.active").removeClass(
                                "active"
                            );
                            jQuery(this).parent("li").addClass("active");
                    ...
                    _t.fadeOut(250, function () {
                        jQuery("#" + cd_container).fadeIn(250, function () {
                            ...
                            currentDate.setSeconds(
                                currentDate.getSeconds() + _seconds
                            );
    ...
    if (jQuery(".masonry-gallery").length > 0) {
        jQuery(".masonry-gallery").each(function () {
            ...
            if (parseInt(_bigImageNo) > 0) {
                ...
                loadScript(
                    plugin_path + "isotope/isotope.pkgd.min.js",
                    function () {
                        setTimeout(function () {
                            _container.isotope({
                                masonry: {
        ...
        loadScript(plugin_path + "toastr/toastr.js", function () {
            ...
            _btn.bind("click", function (e) {
                ...
                var _message = jQuery(this).attr("data-message"),
                    _notifyType =
                        jQuery(this).attr("data-notifyType") || "default",
                    _position =
                        jQuery(this).attr("data-position") || "top-right",
                    _progressBar =
                        jQuery(this).attr("data-progressBar") == "true"
                            ? true
                            : false,
                    _closeButton =
                        jQuery(this).attr("data-closeButton") == "true"
                            ? true
                            : false,
                    _debug =
                        jQuery(this).attr("data-debug") == "true"
                            ? true
                            : false,
                    _newestOnTop =
                        jQuery(this).attr("data-newestOnTop") == "true"
                            ? true
                            : false,
                    _preventDuplicates =
                        jQuery(this).attr("data-preventDuplicates") == "true"
                            ...
                            : false,
                    _showDuration =
                        jQuery(this).attr("data-showDuration") || "300",
                    _hideDuration =
                        jQuery(this).attr("data-hideDuration") || "1000",
                    _timeOut = jQuery(this).attr("data-timeOut") || "5000",
                    _extendedTimeOut =
                        jQuery(this).attr("data-extendedTimeOut") || "1000",
                    _showEasing =
                        jQuery(this).attr("data-showEasing") || "swing",
                    _hideEasing =
                        jQuery(this).attr("data-hideEasing") || "linear",
                    _showMethod =
                        jQuery(this).attr("data-showMethod") || "fadeIn",
                    _hideMethod =
                        jQuery(this).attr("data-hideMethod") || "fadeOut";
            ...
            function () {
                jQuery(".piechart").each(function () {
                    ...
                    _t.easyPieChart({
                        ...
                        scaleColor: false,
                        trackColor:
                            _t.attr("data-trackcolor") || "rgba(0,0,0,0.04)",
...
function _form() {
    ...
    if (jQuery("form.validate-plugin").length > 0) {
        loadScript(
            plugin_path + "form.validate/jquery.form.min.js",
            function () {
                loadScript(
                    ...
                    function () {
                        if (jQuery().validate) {
                            jQuery("form.validate").each(function () {
                                var _t = jQuery(this),
                                    _Smessage =
                                        _t.attr("data-success") ||
                                        "Successfully! Thank you!",
                                    _Cmessage =
                                        _t.attr("data-captcha") ||
                                        "Invalid Captcha!",
                                    _Tposition =
                                        _t.attr("data-toastr-position") ||
                                        "top-right",
                                    _Ttype =
                                        _t.attr("data-toastr-type") ||
                                        "success";
    ...
    if (_container.length > 0) {
        loadScript(
            plugin_path + "form.masked/jquery.maskedinput.js",
            function () {
                _container.each(function () {
                    var _t = jQuery(this);
                    ...
                    _container_1.each(function () {
                        ...
                        jQuery(this)
                            .datepicker({
                                ...
                                language: _lang,
                                rtl:
                                    _t.attr("data-RTL") == "true"
                                        ? true
                                        : false,
                                changeMonth:
                                    _t.attr("data-changeMonth") == "false"
                                        ? false
                                        : true,
                                todayBtn:
                                    _t.attr("data-todayBtn") == "false"
                                        ? false
                                        : "linked",
                                calendarWeeks:
                                    _t.attr("data-calendarWeeks") == "false"
                                        ? false
                                        : true,
                                autoclose:
                                    _t.attr("data-autoclose") == "false"
                                        ? false
                                        : true,
                                todayHighlight:
                                    _t.attr("data-todayHighlight") == "false"
                                        ? false
                                        : true,
                ...
                if (jQuery().markdown) {
                    _container_2.each(function () {
                        ...
                        jQuery(this).markdown({
                            autofocus:
                                _t.attr("data-autofocus") == "true"
                                    ? true
                                    : false,
                            savable:
                                _t.attr("data-savable") == "true"
                                    ? true
                                    : false,
            ...
            function () {
                if (jQuery().pajinate) {
                    _container.each(function () {
                        var _t = jQuery(this),
                            _perPage =
                                _t.attr("data-pajinante-items-per-page") || 8;
                        ...
                        _t.pajinate({
                            ...
                            item_container_id:
                                _t.attr("data-pajinate-container") ||
                                ".pajinate-container",
        ...
        loadScript(
            ...
            function () {
                (_navSelector =
                    ...
                    (_itemSelector =
                        _container.attr("data-itemSelector") || ".item"),
                    ...
                    if (_id) {
                        jQuery(".zoom-more[data-for=" + _id + "] a").bind(
                            ...
                            function (e) {
                                ...
                                if (_href != "#") {
                                    jQuery(
                                        ".zoom-more[data-for=" + _id + "] a"
                                    ).removeClass("active");
                                    jQuery(this).addClass("active");

                                    jQuery("figure#" + _id + ">.lightbox").attr(
                                        "href",
                                        _href
                                    );
                    ...
                    jQuery(".typeahead", _t).typeahead(
                        {
                            limit: _limit,
                            hint:
                                _t.attr("data-hint") == "false" ? false : true,
                            highlight:
                                _t.attr("data-highlight") == "false"
                                    ? false
                                    : true,
...
function _stepper() {
    ...
    if (_container.length > 0) {
        loadScript(
            plugin_path + "form.stepper/jquery.stepper.min.js",
            function () {
                if (jQuery().stepper) {
                    jQuery(_container).each(function () {
                        ...
                        _t.stepper({
                            limit: [_min, _max],
                            floatPrecission:
                                _t.attr("data-floatPrecission") || 2,
                            wheel_step: _t.attr("data-wheelstep") || 0.1,
                            arrow_step: _t.attr("data-arrowstep") || 0.2,
                            allowWheel:
                                _t.attr("data-mousescrool") == "false"
                                    ? false
                                    : true,
                            ...
                            preventWheelAcceleration:
                                _t.attr("data-preventWheelAcceleration") ==
                                "false"
                                    ? false
                                    : true,
                            incrementButton:
                                _t.attr("data-incrementButton") ||
                                "&blacktriangle;",
                            decrementButton:
                                _t.attr("data-decrementButton") ||
                                "&blacktriangledown;",
                            onStep: null,
                            onWheel: null,
                            onArrow: null,
                ...
                if (jQuery().slimScroll) {
                    jQuery(".slimscroll").each(function () {
                        ...
                        jQuery(this).slimScroll({
                            ...
                            position:
                                jQuery(this).attr("data-position") || "right",
                            allowPageScroll: false, // not working
                            disableFadeOut: false,
                            railVisible: true,
                            railColor:
                                jQuery(this).attr("data-railColor") || "#222",
                            railOpacity:
                                jQuery(this).attr("data-railOpacity") || 0.05,
                            alwaysVisible:
                                jQuery(this).attr("data-alwaysVisible") !=
                                "false"
                                    ? true
                                    : false,
                            railVisible:
                                jQuery(this).attr("data-railVisible") != "false"
                                    ? true
                                    : false,
                            color: jQuery(this).attr("data-color") || "#333",
                            wrapperClass:
                                jQuery(this).attr("data-wrapper-class") ||
                                "slimScrollDiv",
                            railColor:
                                jQuery(this).attr("data-railColor") ||
                                "#eaeaea",
                            height: height,
                        });
                        ...
                        if (
                            jQuery(this).attr("disable-body-scroll") == "true"
                        ) {
                            jQuery(this).bind(
                                ...
                                function (e) {
                                    ...
                                    if (scrollTo) {
                                        ...
                                        jQuery(this).scrollTop(
                                            scrollTo + jQuery(this).scrollTop()
                                        );
                                    }
                                }
                            );
        ...
        jQuery("div.modal").each(function () {
            ...
            jQuery("input.loadModalHide", this).bind("click", function () {
                ...
                if (_tt.is(":checked")) {
                    ...
                    console.log(
                        "[Modal Autoload #" + _id + "] Added to localStorage"
                    );
                } else {
                    localStorage.removeItem(_id);
                    console.log(
            ...
            jQuery(_t).each(function () {
                ...
                if (data_background != "") {
                    var data_background_delay =
                        ...
                        data_background_fade =
                            _this.attr("data-background-fade") || 750;
                    var instance;
...
function _widget_flickr() {
    ...
    if (_container.length > 0) {
        loadScript(
            plugin_path + "widget.jflickr/jflickrfeed.min.js",
            function () {
...
function _widget_dribbble() {
    ...
    if (_container.length > 0) {
        loadScript(
            plugin_path + "widget.dribbble/jribbble.min.js",
            function () {
                var _token =
...
function _widget_media() {
    ...
    if (_container.length > 0) {
        loadScript(
            plugin_path +
                "widget.mediaelementbuild/mediaelement-and-player.min.js",
            function () {}
        );
    }
}
