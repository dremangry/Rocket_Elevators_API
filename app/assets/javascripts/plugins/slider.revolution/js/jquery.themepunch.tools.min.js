<<<<<<< HEAD:app/assets/plugins/slider.revolution/js/jquery.themepunch.tools.min.js
/********************************************
...
(function (a) {
    ...
    function C(a4, av) {
        ...
        try {
            ...
            f.error(
                "events not supported " + J + "," + aD + " on jQuery.swipe"
            );
        }
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
            ...
            return (
                ...
                (m.add = function (r, n, a, h) {
                    ...
                    if (
                        ...
                        for (
                            p = this, f = p.rawTime() > r._startTime;
                            p._timeline;
    ...
    (function (t) {
        ...
        "function" == typeof define && define.amd
            ...
            : "undefined" != typeof module &&
              module.exports &&
              (require("./TweenLite.js.js.js"), (module.exports = e()));
    })("TimelineLite");
        ...
        function (t, e) {
            ...
            var h,
                ...
                Y = (function () {
                    ...
                    return (
                        ...
                        (_ =
                            f &&
                            6 > Number(F.substr(F.indexOf("Version/") + 8, 1))),
                ...
                q = z.defaultView
                    ? z.defaultView.getComputedStyle
                    : function () {},
                ...
                Q = (E.calculateOffset = function (t, e, i) {
                    ...
                    return (
                        t["offset" + r] -
                        (G(t, e, parseFloat(s), s.replace(y, "")) || 0)
                    );
                }),
                Z = function (t, e) {
                    var i,
                    ...
                    if ((e = e || q(t, null)))
                        if ((i = e.length))
                            for (; --i > -1; )
                                s[e[i].replace(S, C)] = e.getPropertyValue(
                                    e[i]
                                );
                    ...
                    if (!o[t]) {
                        ...
                        me(t, {
                            parser: function (t, i, r, s, n, a, l) {
                                var h = (_gsScope.GreenSockGlobals || _gsScope)
                          ...
                          p.rotation || p.skewX || p.svg
                              ? ((e = p.rotation * M),
                                ...
                                p.svg &&
                                    ((d +=
                                        p.xOrigin -
                                        (p.xOrigin * a + p.yOrigin * l)),
                                    (m +=
                                        p.yOrigin -
                                        (p.xOrigin * o + p.yOrigin * h)),
                                    (f = 1e-6),
                                    f > d && d > -f && (d = 0),
                                    f > m && m > -f && (m = 0)),
                                (u =
            ...
            (l = a.prototype),
                ...
                (l._enableTransforms = function (t) {
                    (this._transform =
                        this._transform || Ae(this._target, s, !0)),
                        (this._transformType =
                            (this._transform.svg && ve) ||
    ...
    var e = t.GreenSockGlobals || t,
        ...
        g = function (t, e, i) {
            ...
            if (1 === s || 9 === s || 11 === s)
                ...
                (3 === s || 4 === s) &&
                    (t.nodeValue = t.nodeValue.split(e).join(i));
        },
        v = function (t, e) {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    (function (t) {
        ...
        "function" == typeof define && define.amd
            ...
            : "undefined" != typeof module &&
              module.exports &&
              (require("./TweenLite.js.js.js.js.js"), (module.exports = e()));
    })("TimelineLite");
...
>>>>>>> main:app/assets/javascripts/plugins/slider.revolution/js/jquery.themepunch.tools.min.js
