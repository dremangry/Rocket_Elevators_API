...
# Lead.create(full_name_of_the_contact: "Amiya Bond", company_name: "Canadian Tire", email: "A_Bond@canadiantire.ca", phone: "(514)601-9915", project_name: "KingFish", project_description: "Salmon is called the king of fish", department_in_charge_of_elevators: "Night", message: "", attached_file_stored_as_binary: "mountains.", date_of_contact_request: "08/10/2021 06:53:09")

require "faker"



# User.create!(first_name: 'Xi', last_name: 'Jinping', email: 'Xi.Jinping@China1.cn', password: "xj1234")
# Customer.create!(customer_creation_date: Time.new(rand(2015..2021), rand(1..12), rand(1..31), rand(1..24), rand(1..60), rand(1..60)).strftime("%d-%m-%Y %H:%M:%S"), user_id: 12, company_name: Faker::Company.name, full_name_of_the_company_contact: Faker::Name.name, company_contact_phone: Faker::PhoneNumber.cell_phone, email_of_the_company_contact: Faker::Internet.safe_email, company_description: Faker::Company.buzzword, full_name_of_service_technical_authority: Faker::Name.name, technical_authority_phone_for_service: Faker::PhoneNumber.phone_number, technical_manager_email_for_service: Faker::Internet.email)
# 25.times do
#     User.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: Faker::Internet.email, password: "password")
# end

# (20..24).each do |i|
#     Customer.create!(customer_creation_date: Time.new(rand(2015..2021), rand(1..12), rand(1..31), rand(1..24), rand(1..60), rand(1..60)).strftime("%d-%m-%Y %H:%M:%S"), user_id: i, company_name: Faker::Company.name, full_name_of_the_company_contact: Faker::Name.name, company_contact_phone: Faker::PhoneNumber.cell_phone, email_of_the_company_contact: Faker::Internet.safe_email, company_description: Faker::Company.buzzword, full_name_of_service_technical_authority: Faker::Name.name, technical_authority_phone_for_service: Faker::PhoneNumber.phone_number, technical_manager_email_for_service: Faker::Internet.email)
# end
...
#    Building.create!(customer_id: i, full_name_of_the_building_administrator: name, email_of_the_administrator_of_the_building: email,phone_number_of_the_building_administrator: phone, full_name_of_the_technical_contact_for_the_building: name2,technical_contact_email_for_the_building: email2, technical_contact_phone_for_the_building: phone2)
# end

# (1..10).each do |i|
#     status = ["on", "off"]
#     Column.create!(type: Faker::Company.type, number_of_floors_served: Faker::Number.between(from: 1, to: 100),  status: status.sample, information: Faker::Company.buzzword, notes: Faker::ChuckNorris.fact)
# end
...
#     Elevator.create!(column_id: i, serial_number: Faker::IDNumber.valid_south_african_id_number, model: model.sample, typing: typing.sample, 
#     status: status.sample, date_of_commissioning: Time.new(rand(2015..2021), rand(1..12), rand(1..31), rand(1..24), rand(1..60), rand(1..60)).strftime("%d-%m-%Y %H:%M:%S"), 
#     date_of_last_inspection: Time.new(rand(2021..2022), rand(1..12), rand(1..31), rand(1..24), rand(1..60), rand(1..60)).strftime("%d-%m-%Y %H:%M:%S"), information: Faker::Company.buzzword, 
